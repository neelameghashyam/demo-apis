...
public class WebhookServiceImpl implements WebhookService {
    ...
    public WebhookServiceImpl(WebhookRepository webhookRepository, UserRepository userRepository, Mappers mappers) {
    ...
    public WebhookDTO saveWebhook(WebhookDTO webhookDTO) {
        ...
        // Set dataTypes directly from DTO
        webhook.setDataTypes(webhookDTO.dataTypes());
    ...
    public WebhookDTO updateWebhook(WebhookDTO webhookDTO) throws WebhookNotFoundException {
        ...
        webhook.setDataTypes(webhookDTO.dataTypes()); // Update dataTypes
        if (webhookDTO.userId() != null) {
            User user = userRepository.findById(webhookDTO.userId())
                    .orElseThrow(() -> new IllegalArgumentException("User not found"));
            webhook.setUser(user);
